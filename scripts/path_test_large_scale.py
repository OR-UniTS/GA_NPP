...
file_name = 'Results/PathResults/path_results_large_scale.csv'
...
for partial in [True, False]:
    ...
    for run in range(10):
        ...
        print(f"GA time: {genetic_h.time:.2f}, GAH time: {genetic_h.time:.2f}, Solver time: {solver.time:.2f}, "
              f" GA gap diff: {1 - g.best_val / solver.obj:.2%}"
              f" GAH gap diff: {1 - genetic_h.best_val / solver.obj:.2%}")
